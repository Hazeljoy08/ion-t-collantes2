...
const cardData = [
  {
    ...
    subtitle: 'Applet #1',
    link: '/ion-t-collantes2/Home/clickcounter'
  },
  {
    title: 'Calculator',
    icon: calculator,
    subtitle: 'Applet #2',
    link: '/ion-t-collantes2/Home/calculator'
  },
  {
    title: 'To Do List',
    icon: pencil,
    subtitle: 'Applet #3',
    link: '/ion-t-collantes2/Home/todolist'
  },
  {
    title: 'Quotes Generator',
    icon: chatbubble,
    subtitle: 'Applet #4',
    link: '/ion-t-collantes2/Home/quotesgenerator'
  },
